                ...
                return (
                  ...
                  >
                    ...
                    <div className="slider-content">
                      <h2 className="color-title color-title--blue space-mb--20" style={{color : "white"}}>
                        {single.subtitle}
                      </h2>
                      <h1
                      ...
                      >
                        <a className="lezada-button lezada-button--medium" style={{backgroundColor : "#31de79",color : "white"}}>
                          Explore
                        </a>
                      </Link>
                    </div>
